  ...
  <div className="relative w-80 lg:w-72 mx-auto md:h-[400px] rounded-tr-3xl rounded-bl-3xl border-2 md:hover:scale-95 duration-700 shadow-lg shadow-black border-yellow-600 md:m-3 bg-[#d2d2b4] md:hover:shadow-xl md:hover:shadow-slate-400">
    <a href={exploreLink}>
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="text-lg md:text-xl text-center font-glacial font-semibold">{label}</p>
        <div className="mx-auto border-b-2 border-gray-600 p-1">
          <p className="text-lg md:text-2xl text-center font-glacial">{title}</p>
        </div>
        <div className="flex flex-col gap-3 mx-auto p-3">
          <p className="animate__zoomIn text-lg md:text-2xl text-center font-bold font-times">
  ...
  return (
    <div>
      ...
      <section className="flex flex-col justify-center p-3">
        ...
        <h3 className="text-2xl md:text-4xl w-fit mx-auto rounded-2xl text-[#d2d2b4] bg-black bg-opacity-20 tracking-widest font-berkshire text-center p-5">
