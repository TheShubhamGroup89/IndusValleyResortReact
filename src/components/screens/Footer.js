...
const Footer = () => {
  ...
  <div className=" lg:pl-20 flex flex-col md:flex-row pl-10 justify-between md:p-10 p-5 gap-10 text-[#e9e9d0] bg-black bg-opacity-30 border-y-2 border-[#d2d2b4]">
    ...
    <section className="flex flex-col md:w-1/4 w-full gap-5 font-french-canon">

          <p className=" text-2xl md:text-3xl">
            Site Address
          </p>
          <p className=" text-base font-glacial">
            Managher, Near Dhanachuli Band,<br/> Village - Sunderkhal,<br/> Tehsil - Dhari,<br/>Nainital, Uttrakhand.<br/> Pincode - 263132
          </p>    

        </section>
        <section className="flex flex-col w-full md:w-1/4 gap-5 font-french-canon">
        ...
        <section className="flex flex-col w-full md:w-1/4 md:px-10 gap-5 ">
          ...
          <p className=" text-2xl md:text-3xl font-french-canon">
            Contact Us
          </p>
          <div className="flex flex-col">
            <a
              className=" text-lg font-glacial tracking-wide hover:text-blue-400 "
            ...
            <p className=" text-lg font-glacial pt-2">
               Ms.Tanushka Banerjee<br/> (Booking Mgr.)
              </p>
            {/* <a
      ...
      <section class="copy-right text-[#e9e9d0] bg-black bg-opacity-30 flex flex-col md:flex-row justify-center items-center pb-10 gap-1">
        ...
        <p className=" text-center text-sm font-glacial ">
