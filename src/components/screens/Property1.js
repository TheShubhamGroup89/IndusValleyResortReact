  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-0">
        <section className="grid md:grid-cols-2 mx-auto m-3 p-5 gap-10 md:gap-20">
          {/* ....(1.1).... */}
          {/* <div className="w-fit md:w-96 rounded-xl border-2 shadow-lg md:m-3 bg-[#E4F7E8] shadow-slate-200">
            ...
            <div>
              <div className="mx-auto border-b-2 border-green-300 my-2 p-3">
                <h2 className=" text-xl md:text-2xl text-[#40392d] font-times font-semibold">
                  IVR - 10
                </h2>
              ...
              <div className="flex flex-col gap-3 mx-auto p-3">
                <p className="animate__zoomIn text-lg md:text-3xl font-bold font-times">
 ...
 <img
         ...
         <img className="w-20 absolute bottom-0 right-0 z-10" src={discount} alt="discount%" />
          ...
          >
            ...
            <div className="relative w-fit md:w-80 xl:w-96 rounded-tr-3xl rounded-bl-3xl border-2 shadow-lg md:hover:scale-95 duration-700 md:m-3 bg-gradient-to-r from-green-200 to-neutral-400 shadow-slate-200">
