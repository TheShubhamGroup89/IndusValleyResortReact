...
const Contact = () => {
  return (
    <>
      ...
      >
        <h2 className="w-full md:w-3/4 animate__zoomIn text-xl md:text-4xl text-center px-3 my-3 md:my-0 tracking-wider text-white bg-black bg-opacity-50 md:text-black md:bg-white md:bg-opacity-20 rounded-xl justify-center pb-5 font-merriweather">
        ...
        <Link
          ...
          className="bg-[#3E6527] border-2 w-fit font-semibold font-merriweather px-4 py-2.5 m-2 rounded-md hover:bg-black text-white hover:font-bold focus:outline-none focus:bg-blue-600"
        >
          Go Back
        </Link>
      </div>
